...
ChatPulse 是一个本地优先的 AI 社交模拟应用。它不是只负责“发一句话、回一句话”的聊天壳，而是把私聊、群聊、长期记忆、朋友圈、秘密日记、关系网络、经济、商业街、小屋、像素世界、住房社交、后台管理和实验性联网工具放进同一个可持续运行的本地世界。
...
- 钱包、私聊转账、群红包和商业街金币同步。
- 管理员后台、备份恢复、主题生成、MCP 实验台和本地安全边界。
...
- 私聊转账、钱包、好感、印象、日记、朋友圈和商业街意图都可进入后续链路。
...
- 支持导入 zip 或数据库文件。
- 支持系统擦除。
- 角色包导入 / 导出包含聊天、记忆、朋友圈、日记和可重建 Qdrant 索引的数据。
- 导入路径做了路径穿越防护。
